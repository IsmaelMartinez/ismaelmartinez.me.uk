...
No entraré en detalle sobre cada una aquí. Otras señales emergentes incluyen Events y Profiles — para monitorización de usuarios reales. Para una mirada más profunda a para qué sirve cada señal y cómo encajan entre sí, consulta [Señales de OpenTelemetry](/es/articles/opentelemetry-signals).
