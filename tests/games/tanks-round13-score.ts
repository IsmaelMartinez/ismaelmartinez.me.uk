/**
 * Tank Duel's round 13 score, frozen as it was before its round 2 rescore
 * (#379), for `audio-graph.test.ts`. That suite proves the engine still builds
 * exactly the graph it always built for a score that uses none of its newer
 * fields (form, drums, pulse duties, vibrato, layers), and this march, with its
 * pad, detuned twins and echo, was the score that proved it. The rescore moved
...
export const TANKS_ROUND13_MUSIC: GameAudioOptions = {
  tempo: 116,
  volume: 0.1,
