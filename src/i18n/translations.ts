...
export const translations = {
  en: {
    ...
    'about.values.description': 'I believe in thoughtful simplicity — solving real problems without overengineering. Sustainability and accessibility are not afterthoughts but foundations. I value knowledge sharing as a way to give back to the community that helped me grow.',
    'about.writing.title': 'Writing & Speaking',
    'about.writing.description': 'I write about software engineering, architecture, and the intersection of technology with accessibility and sustainability. I also enjoy speaking at conferences and meetups, sharing lessons from two decades of building and shipping software.',
  ...
  es: {
    ...
    'about.values.description': 'Creo en la simplicidad reflexiva — resolver problemas reales sin sobreingeniería. La sostenibilidad y la accesibilidad no son ocurrencias tardías sino cimientos. Valoro compartir conocimiento como forma de devolver a la comunidad que me ayudó a crecer.',
    'about.writing.title': 'Escritura y charlas',
    'about.writing.description': 'Escribo sobre ingeniería de software, arquitectura y la intersección de la tecnología con la accesibilidad y la sostenibilidad. También disfruto hablando en conferencias y meetups, compartiendo lecciones de dos décadas construyendo y desplegando software.',
  ...
  cat: {
    ...
    'about.values.description': 'Crec en la simplicitat reflexiva — resoldre problemes reals sense sobreenginyeria. La sostenibilitat i l\'accessibilitat no són ocurrències tardanes sinó fonaments. Valoro compartir coneixement com a forma de retornar a la comunitat que em va ajudar a créixer.',
    'about.writing.title': 'Escriptura i xerrades',
    'about.writing.description': 'Escric sobre enginyeria de programari, arquitectura i la intersecció de la tecnologia amb l\'accessibilitat i la sostenibilitat. També gaudeixo parlant a conferències i meetups, compartint lliçons de dues dècades construint i desplegant programari.',
