...
// A basher assigned this far short of a wall still walks into it and connects, so
// the corridor the player has to click inside is BASH_PATIENCE + 1 px wide (6 gave
// a 7px window, barely 117ms of walking).
export const BASH_PATIENCE = 12; // steps a basher walks toward a wall before giving up
