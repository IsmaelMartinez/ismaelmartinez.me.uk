...
No entraré en detall sobre cadascun aquí. Altres senyals emergents inclouen Events i Profiles — per al monitoratge d'usuaris reals. Per a una mirada més profunda sobre per a què serveix cada senyal i com encaixen entre si, consulta [Senyals d'OpenTelemetry](/cat/articles/opentelemetry-signals).
