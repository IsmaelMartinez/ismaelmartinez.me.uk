...
export const translations = {
  en: {
    ...
    'fun.tanks.keys': 'Keys: ← → angle · ↑ ↓ power · Space to fire',
  ...
  es: {
    ...
    'fun.tanks.keys': 'Teclas: ← → ángulo · ↑ ↓ potencia · Espacio para disparar',
  ...
  cat: {
    ...
    'fun.tanks.keys': 'Tecles: ← → angle · ↑ ↓ potència · Espai per disparar',
