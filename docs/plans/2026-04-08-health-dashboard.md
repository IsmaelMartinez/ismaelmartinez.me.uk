...
- [x] **Step 1: Add tier colours to the `:root` block**
...
- [x] **Step 2: Verify the dev server shows no errors**
...
- [x] **Step 1: Add English translations**
...
- [x] **Step 2: Add Spanish translations**
...
- [x] **Step 3: Add Catalan translations**
...
- [x] **Step 3: Create src/data/health.ts**
...
- [x] **Step 1: Create Sparkline.astro**
...
- [x] **Step 2: Create TierPulse.astro**
...
- [x] **Step 3: Create HealthCard.astro (mobile card)**
...
- [x] **Step 4: Create HealthTable.astro (desktop table)**
...
- [x] **Step 5: Create PortfolioHealthBadge.astro**
...
- [x] **Step 2: Add PortfolioHealthBadge to projects page**
...
- [x] **Step 1: Add health page build test**
...
- [x] **Step 2: Add daily cron to gh-pages.yml**
